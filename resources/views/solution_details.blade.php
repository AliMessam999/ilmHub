            ...
            <div class="row">
                <div class="cell-12">
                    ...
                    <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                        <span class="bold">You Are In:</span><a href="#">Solutions</a><span class="line-separate">/</span><a href="#">{!! __($solution->category->title) !!}</a><span class="line-separate">/</span><span>{!! __($solution->category->parent_item->title) !!}</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="cell-9">
                    <div class="post-image details-img">
                        <a href="{{ url($solution->image) }}" class="zoom">
                            <div class="mask"></div>
                            <img src="{{ url($solution->image) }}" alt="Our Blog post image goes here">
                        </a>
                    </div>
