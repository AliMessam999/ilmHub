                        ...
                        <div class="white_card_body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label>Sort</label>
                                    <div class="common_input mb_15">
                                        <input type="number" name="sort" placeholder="Enter Sort No"
                                            autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label>Link</label>
                                    <div class="common_input mb_15">
                                        <input type="text" name="link" placeholder="Enter link of website of client"
                                            autocomplete="off">
                                    </div>
                                </div>
                            </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.message != "") {
                        ...
                        window.location.assign('{{ route('client_list') }}');
                    }
                },
                error: function(data) {
