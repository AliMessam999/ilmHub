...
<body class="crm_body_bg">
    ...
    <nav class="sidebar">
        <div class="logo d-flex justify-content-between">
            <a class="large_logo" href="/"><img src="{{ url('img/logo.png') }}" height="50px" alt></a>
            <a class="small_logo" href="/"><img src="{{ url('img/logo.png') }}" height="50px" alt></a>
        ...
        <ul id="sidebar_menu">
                ...
                <li>
                    <a href="/dashboard" aria-expanded="false">
                        <div class="nav_icon_small">
                            <i class="fa fa-th-large" style="color: #048391;"></i>
                        </div>
                        <div class="nav_title">
                            <span>Dashboard</span>
                        </div>
            ...
            @if (auth()->user()->haspermission('read-gallary'))
                <li class>
                    <a class="" href="/admin/gallary" aria-expanded="false">
                        <div class="nav_icon_small">
            ...
            @endif
            @if (auth()->user()->haspermission('read-careers'))
                <li class>
                    <a class="" href="/admin/career" aria-expanded="false">
                        <div class="nav_icon_small">
                            <i class="fa fa-hands-helping" style="color: #048391;"></i>
                        </div>
                        <div class="nav_title">
                            <span>Careers</span>
                        </div>
            ...
            @endif
            @if (auth()->user()->haspermission('read-solutions'))
                <li class>
                    <a class="" href="/admin/solution" aria-expanded="false">
                        <div class="nav_icon_small">
                            <i class="fa fa-unlock" style="color: #048391;"></i>
                        </div>
                        <div class="nav_title">
                            <span>Solutions</span>
                        </div>
            ...
            @endif
            @if (auth()->user()->haspermission('read-news'))
                <li class>
                    <a class="" href="/admin/news" aria-expanded="false">
                        <div class="nav_icon_small">
                        ...
                        <div class="serach_field-area d-flex align-items-center">
                            <div class="search_inner">
                                <form action="#">
                                    ...
                                    <button type="submit"> <img src="{{ url('img/icon/icon_search.svg') }}" alt>
                                    </button>
                                </form>
                            </div>
                        </div>
