                    ...
                    <div class="white_card_header">
                        <div class="box_header m-0">
                            <div class="main-title">
                                <h3 class="m-0">Update Team Member</h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="common_input mb_15">
                                        <input type="text" name="name" value="{{ __($menu->name) }}"
...
@section('scripts')
    <script>
        $("#CircleForm").on("submit", function(e) {
            ...
            $.ajax({
                url: "/admin/team_member/update/" + id,
                method: "POST",
                data: formData,
                ...
                success: function(data) {
                    ...
                    if (data.message != "") {
                        ...
                        window.location.assign('{{ route('team_member_list') }}');
                    }
                },
                error: function(data) {
