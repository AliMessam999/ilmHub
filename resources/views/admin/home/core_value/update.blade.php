                    ...
                    <div class="white_card_header">
                        <div class="box_header m-0">
                            <div class="main-title">
                                <h3 class="m-0">Update Core Values</h3>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex gap-5 align-items-center h-100">
                                        ...
                                        <div class="fileupload btn btn_1 radius_btn btn-anim"><i
                                                class="fa fa-upload"></i><span class="btn-text">Upload Video</span>
...
@section('scripts')
    <script>
        $("#CircleForm").on("submit", function(e) {
            ...
            $.ajax({
                url: "/admin/core_value/update/" + id,
                method: "POST",
                data: formData,
                ...
                success: function(data) {
                    ...
                    if (data.message != "") {
                        ...
                        window.location.assign('{{ route('core_value_list') }}');
                    }
                },
                error: function(data) {
