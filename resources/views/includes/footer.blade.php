<footer class="tj-footer-section footer-2 h5-footer h6-footer section-gap-x">
                    ...
                    <div class="footer-widget widget-contact h6-footer-contact wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <div class="footer-contact-info">
                            ...
                            <div class="contact-item">
                                ...
                                <a href="mailto:support@Cdigital.com">M: support@Cdigital.com</a>
                            </div>
                            <div class="contact-item">
                ...
                <div class="col-12">
                    <div class="h6-footer-logo">
                        <a href="index.html" class="wow fadeInUpBig" data-wow-delay=".3s">
                            <img src="{{ asset('frontend_assets/images/logos/logolarge.png') }}" alt="" />
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-shape-3 wow fadeInUpBig" data-wow-delay="1s">
        <img src="{{ asset('frontend_assets/images/shape/footer-bg-shape-blur.svg') }}" alt="" />
    </div>
</footer>
