        ...
        <div class="container">
            <div class="row">
                <div class="cell-12">
                    ...
                    <h1 class="fx" data-animate="fadeInLeft"><span>{!! __($new->title) !!}</span></h1>
                    <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                        <span class="bold">You Are In:</span><a href="#">News</a><span class="line-separate">/</span><a href="#">{!! __($new->category->title) !!}</a><span class="line-separate">/</span><span>{!! __($new->title) !!}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="cell-9">
                    <div class="post-image details-img">
                        <a href="{{ url($new->image) }}" class="zoom">
                            <div class="mask"></div>
                            <img src="{{ url($new->image) }}" alt="Our Blog post image goes here">
                        </a>
                    </div>
                    <div class="p-3 news_details">{!! __($new->description) !!}</div>
