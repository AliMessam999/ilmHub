                        ...
                        <div class="blog-text wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="accordion tj-faq style-2" id="faqOne">
                                ...
                                @foreach ($faqs as $index => $faq)
                                    <div class="accordion-item wow fadeInUp {{ $index == 0 ? 'active' : '' }}"
                                        data-wow-delay=".3s">
                ...
                <div class="col-lg-4">
                    <div class="tj-main-sidebar slidebar-stickiy">
                        <div class="tj-sidebar-widget service-categories wow fadeInUp" data-wow-delay=".1s">
                            ...
                            <ul>
                                @foreach ($categories as $category)
                                    <li>
                                        <a class="{{ $category->slug == $slug ? 'active' : '' }}"
                                            href="{{ $category->slug }}">{{ $category->title }}<span class="icon"><i
                        ...
                        @php
                            ...
                            $teamMembers = CdTeamMember::where(
                                'division',
                                'LIKE',
